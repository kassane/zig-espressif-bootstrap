...
; ESPV 2.1 only (+xespv2p1, esp32p4eco4). Shared-intrinsic 2.2 bitrev: see
; riscv-esp32p4-movx-r-w-fft-bit-width.ll (+xespv, esp32p4).
...
define dso_local void @test_fft_bitrev_m(ptr noundef %Rs1, ptr noundef %dst) local_unnamed_addr #0 {
