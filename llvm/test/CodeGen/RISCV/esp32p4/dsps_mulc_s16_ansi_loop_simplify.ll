...
; CHECK-NEXT:    br i1 [[TMP0]], label %[[FAST_PATH_PREHEADER:.*]], label %[[FOR_BODY:.*]]
; CHECK:       [[FAST_PATH_PREHEADER]]:
; CHECK-NEXT:    [[CONV5_FAST:%.*]] = sext i16 [[C]] to i32
; CHECK-NEXT:    br label %[[FOR_BODY_FAST:.*]]
; CHECK:       [[FOR_BODY_FAST]]:
; CHECK-NEXT:    [[I_016_FAST:%.*]] = phi i32 [ 0, %[[FAST_PATH_PREHEADER]] ], [ [[INC_FAST:%.*]], %[[FOR_BODY_FAST]] ]
; CHECK-NEXT:    [[MUL_FAST:%.*]] = mul nsw i32 [[I_016_FAST]], 1
; CHECK-NEXT:    [[ARRAYIDX_FAST:%.*]] = getelementptr inbounds i16, ptr [[INPUT]], i32 [[MUL_FAST]]
; CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr [[ARRAYIDX_FAST]], align 2, !tbaa [[TBAA6:![0-9]+]]
; CHECK-NEXT:    [[CONV_FAST:%.*]] = sext i16 [[TMP1]] to i32
...
; CHECK-NEXT:    [[MUL8_FAST:%.*]] = mul nsw i32 [[I_016_FAST]], 1
; CHECK-NEXT:    [[ARRAYIDX9_FAST:%.*]] = getelementptr inbounds i16, ptr [[OUTPUT]], i32 [[MUL8_FAST]]
; CHECK-NEXT:    store i16 [[CONV7_FAST]], ptr [[ARRAYIDX9_FAST]], align 2, !tbaa [[TBAA6]]
; CHECK-NEXT:    [[INC_FAST]] = add nuw nsw i32 [[I_016_FAST]], 1
...
; CHECK-NEXT:    [[TMP2:%.*]] = load i16, ptr [[ARRAYIDX]], align 2, !tbaa [[TBAA6]]
...
; CHECK-NEXT:    store i16 [[CONV7]], ptr [[ARRAYIDX9]], align 2, !tbaa [[TBAA6]]
