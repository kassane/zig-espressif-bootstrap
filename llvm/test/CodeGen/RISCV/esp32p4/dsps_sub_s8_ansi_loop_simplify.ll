...
; CHECK:       [[FOR_BODY_FAST]]:
; CHECK-NEXT:    [[I_023_FAST:%.*]] = phi i32 [ [[INC_FAST:%.*]], %[[FOR_BODY_FAST]] ], [ 0, %[[FAST_PATH_PREHEADER]] ]
; CHECK-NEXT:    [[MUL_FAST:%.*]] = mul nsw i32 [[I_023_FAST]], 1
; CHECK-NEXT:    [[ARRAYIDX_FAST:%.*]] = getelementptr inbounds i8, ptr [[INPUT1]], i32 [[MUL_FAST]]
; CHECK-NEXT:    [[TMP2:%.*]] = load i8, ptr [[ARRAYIDX_FAST]], align 1, !tbaa [[TBAA6:![0-9]+]]
; CHECK-NEXT:    [[CONV_FAST:%.*]] = sext i8 [[TMP2]] to i32
; CHECK-NEXT:    [[MUL8_FAST:%.*]] = mul nsw i32 [[I_023_FAST]], 1
; CHECK-NEXT:    [[ARRAYIDX9_FAST:%.*]] = getelementptr inbounds i8, ptr [[INPUT2]], i32 [[MUL8_FAST]]
; CHECK-NEXT:    [[TMP3:%.*]] = load i8, ptr [[ARRAYIDX9_FAST]], align 1, !tbaa [[TBAA6]]
; CHECK-NEXT:    [[CONV10_FAST:%.*]] = sext i8 [[TMP3]] to i32
...
; CHECK-NEXT:    [[MUL12_FAST:%.*]] = mul nsw i32 [[I_023_FAST]], 1
; CHECK-NEXT:    [[ARRAYIDX13_FAST:%.*]] = getelementptr inbounds i8, ptr [[OUTPUT]], i32 [[MUL12_FAST]]
; CHECK-NEXT:    store i8 [[CONV11_FAST]], ptr [[ARRAYIDX13_FAST]], align 1, !tbaa [[TBAA6]]
; CHECK-NEXT:    [[INC_FAST]] = add nuw nsw i32 [[I_023_FAST]], 1
; CHECK-NEXT:    [[EXITCOND_NOT_FAST:%.*]] = icmp eq i32 [[INC_FAST]], [[LEN]]
; CHECK-NEXT:    br i1 [[EXITCOND_NOT_FAST]], label %[[RETURN_LOOPEXIT:.*]], label %[[FOR_BODY_FAST]], !llvm.loop [[LOOP9:![0-9]+]]
; CHECK:       [[FOR_BODY]]:
; CHECK-NEXT:    [[I_023:%.*]] = phi i32 [ [[INC:%.*]], %[[FOR_BODY]] ], [ 0, %[[FOR_BODY_PREHEADER]] ]
; CHECK-NEXT:    [[MUL:%.*]] = mul nsw i32 [[I_023]], [[STEP1]]
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i8, ptr [[INPUT1]], i32 [[MUL]]
; CHECK-NEXT:    [[TMP4:%.*]] = load i8, ptr [[ARRAYIDX]], align 1, !tbaa [[TBAA6]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = load i8, ptr [[ARRAYIDX9]], align 1, !tbaa [[TBAA6]]
; CHECK-NEXT:    [[CONV10:%.*]] = sext i8 [[TMP5]] to i32
...
; CHECK-NEXT:    store i8 [[CONV11]], ptr [[ARRAYIDX13]], align 1, !tbaa [[TBAA6]]
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[I_023]], 1
; CHECK-NEXT:    [[EXITCOND_NOT:%.*]] = icmp eq i32 [[INC]], [[LEN]]
; CHECK-NEXT:    br i1 [[EXITCOND_NOT]], label %[[RETURN_LOOPEXIT]], label %[[FOR_BODY]], !llvm.loop [[LOOP9]]
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %1 = load i8, ptr %arrayidx9, align 1, !tbaa !6
