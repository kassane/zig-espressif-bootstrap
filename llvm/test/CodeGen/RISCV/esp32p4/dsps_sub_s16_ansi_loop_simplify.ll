...
define dso_local range(i32 0, 458756) i32 @dsps_sub_s16_ansi(ptr noundef readonly %input1, ptr noundef readonly %input2, ptr noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out, i32 noundef %shift) local_unnamed_addr #0 {
...
; CHECK-NEXT:    [[ARRAYIDX13_FAST:%.*]] = getelementptr inbounds i16, ptr [[OUTPUT]], i32 [[MUL12_FAST]]
; CHECK-NEXT:    store i16 [[CONV11_FAST]], ptr [[ARRAYIDX13_FAST]], align 2, !tbaa [[TBAA6]]
...
; CHECK-NEXT:    store i16 [[CONV11]], ptr [[ARRAYIDX13]], align 2, !tbaa [[TBAA6]]
