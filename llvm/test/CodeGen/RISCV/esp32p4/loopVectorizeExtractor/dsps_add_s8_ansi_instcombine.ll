...
define dso_local range(i32 0, 458756) i32 @dsps_add_s8_ansi(ptr noundef readonly %input1, ptr noundef readonly %input2, ptr noundef writeonly %output, i32 noundef %len, i32 noundef %step1, i32 noundef %step2, i32 noundef %step_out, i32 noundef %shift) local_unnamed_addr #0 {
; CHECK-LABEL: define dso_local range(i32 0, 458756) i32 @dsps_add_s8_ansi(
...
; CHECK-NEXT:    [[TMP20:%.*]] = add nsw <16 x i32> [[TMP19]], [[TMP18]]
