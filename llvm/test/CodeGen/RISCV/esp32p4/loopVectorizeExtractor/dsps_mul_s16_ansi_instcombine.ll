...
; CHECK-NEXT:    [[TMP26:%.*]] = mul nsw <8 x i32> [[TMP25]], [[TMP24]]
...
; CHECK-NEXT:    store i16 [[CONV12_FAST]], ptr [[LSR_IV59]], align 2, !tbaa [[TBAA6]]
...
; CHECK-NEXT:    store i16 [[CONV12]], ptr [[LSR_IV48]], align 2, !tbaa [[TBAA6]]
...
for.body.fast:                                    ; preds = %for.body.fast, %fast.path.preheader
  %i.024.fast = phi i32 [ %inc.fast, %for.body.fast ], [ 0, %fast.path.preheader ]
  %arrayidx.fast = getelementptr inbounds i16, ptr %input1, i32 %i.024.fast
  %2 = load i16, ptr %arrayidx.fast, align 2, !tbaa !6
  %conv.fast = sext i16 %2 to i32
  %arrayidx9.fast = getelementptr inbounds i16, ptr %input2, i32 %i.024.fast
  %3 = load i16, ptr %arrayidx9.fast, align 2, !tbaa !6
  %conv10.fast = sext i16 %3 to i32
  %mul11.fast = mul nsw i32 %conv10.fast, %conv.fast
  %shr.fast = ashr i32 %mul11.fast, %shift
  %conv12.fast = trunc i32 %shr.fast to i16
  %arrayidx14.fast = getelementptr inbounds i16, ptr %output, i32 %i.024.fast
  store i16 %conv12.fast, ptr %arrayidx14.fast, align 2, !tbaa !6
  %inc.fast = add nuw nsw i32 %i.024.fast, 1
