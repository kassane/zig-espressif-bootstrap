...
; RUN: llc -O1 -mtriple=riscv32 -mattr=+xespv,+espv-lowering -verify-machineinstrs < %s \
; RUN:   | FileCheck %s -check-prefix=CHECK
; RUN: llc -O1 -mtriple=riscv32 -mattr=+xespv2p2,+espv-lowering -verify-machineinstrs < %s \
; RUN:   | FileCheck %s -check-prefix=CHECK
