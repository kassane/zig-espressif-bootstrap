...
; CHECK-LABEL: define dso_local noundef i32 @dspi_dotprod_off_s16_ansi(
; CHECK-SAME: ptr noalias noundef readonly captures(none) [[IN_IMAGE:%.*]], ptr noalias noundef readonly captures(none) [[FILTER:%.*]], ptr noalias noundef writeonly captures(none) [[OUT_VALUE:%.*]], i32 noundef [[COUNT_X:%.*]], i32 noundef [[COUNT_Y:%.*]], i32 noundef [[SHIFT:%.*]], i16 noundef signext [[OFFSET:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[ADD:%.*]] = add nsw i32 [[CONV34]], [[CONV35]]
; CHECK-NEXT:    [[MUL36:%.*]] = mul nsw i32 [[ADD]], [[CONV]]
; CHECK-NEXT:    [[CONV37:%.*]] = sext i32 [[MUL36]] to i64
...
; CHECK-NEXT:    [[ADD_1:%.*]] = add nsw i32 [[CONV34_1]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_1:%.*]] = mul nsw i32 [[ADD_1]], [[CONV_1]]
; CHECK-NEXT:    [[CONV37_1:%.*]] = sext i32 [[MUL36_1]] to i64
...
; CHECK-NEXT:    [[ADD_2:%.*]] = add nsw i32 [[CONV34_2]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_2:%.*]] = mul nsw i32 [[ADD_2]], [[CONV_2]]
; CHECK-NEXT:    [[CONV37_2:%.*]] = sext i32 [[MUL36_2]] to i64
...
; CHECK-NEXT:    [[ADD_3:%.*]] = add nsw i32 [[CONV34_3]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_3:%.*]] = mul nsw i32 [[ADD_3]], [[CONV_3]]
; CHECK-NEXT:    [[CONV37_3:%.*]] = sext i32 [[MUL36_3]] to i64
...
; CHECK-NEXT:    [[ADD_4:%.*]] = add nsw i32 [[CONV34_4]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_4:%.*]] = mul nsw i32 [[ADD_4]], [[CONV_4]]
; CHECK-NEXT:    [[CONV37_4:%.*]] = sext i32 [[MUL36_4]] to i64
...
; CHECK-NEXT:    [[ADD_5:%.*]] = add nsw i32 [[CONV34_5]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_5:%.*]] = mul nsw i32 [[ADD_5]], [[CONV_5]]
; CHECK-NEXT:    [[CONV37_5:%.*]] = sext i32 [[MUL36_5]] to i64
...
; CHECK-NEXT:    [[ADD_6:%.*]] = add nsw i32 [[CONV34_6]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_6:%.*]] = mul nsw i32 [[ADD_6]], [[CONV_6]]
; CHECK-NEXT:    [[CONV37_6:%.*]] = sext i32 [[MUL36_6]] to i64
...
; CHECK-NEXT:    [[ADD_7:%.*]] = add nsw i32 [[CONV34_7]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_7:%.*]] = mul nsw i32 [[ADD_7]], [[CONV_7]]
; CHECK-NEXT:    [[CONV37_7:%.*]] = sext i32 [[MUL36_7]] to i64
...
; CHECK-NEXT:    [[ADD_CLONE:%.*]] = add nsw i32 [[CONV34_CLONE]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_CLONE:%.*]] = mul nsw i32 [[ADD_CLONE]], [[CONV_CLONE]]
; CHECK-NEXT:    [[CONV37_CLONE:%.*]] = sext i32 [[MUL36_CLONE]] to i64
