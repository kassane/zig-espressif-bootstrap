...
define dso_local noundef i32 @dspi_dotprod_u16_ansi(ptr nocapture noundef readonly %in_image, ptr nocapture noundef readonly %filter, ptr nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift) local_unnamed_addr #0 {
; CHECK-LABEL: define dso_local noundef i32 @dspi_dotprod_u16_ansi(
...
; CHECK-NEXT:    [[CONV36:%.*]] = zext nneg i32 [[MUL35]] to i64
...
; CHECK-NEXT:    [[CONV36_1:%.*]] = zext nneg i32 [[MUL35_1]] to i64
...
; CHECK-NEXT:    [[CONV36_2:%.*]] = zext nneg i32 [[MUL35_2]] to i64
...
; CHECK-NEXT:    [[CONV36_3:%.*]] = zext nneg i32 [[MUL35_3]] to i64
...
; CHECK-NEXT:    [[CONV36_4:%.*]] = zext nneg i32 [[MUL35_4]] to i64
...
; CHECK-NEXT:    [[CONV36_5:%.*]] = zext nneg i32 [[MUL35_5]] to i64
...
; CHECK-NEXT:    [[CONV36_6:%.*]] = zext nneg i32 [[MUL35_6]] to i64
...
; CHECK-NEXT:    [[CONV36_7:%.*]] = zext nneg i32 [[MUL35_7]] to i64
...
; CHECK-NEXT:    [[CONV36_CLONE:%.*]] = zext nneg i32 [[MUL35_CLONE]] to i64
