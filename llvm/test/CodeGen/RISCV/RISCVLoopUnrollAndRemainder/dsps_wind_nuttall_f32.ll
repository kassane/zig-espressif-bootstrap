...
define dso_local void @dsps_wind_nuttall_f32(ptr nocapture noundef writeonly %window, i32 noundef %len) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @dsps_wind_nuttall_f32(
...
; CHECK-NEXT:    [[TMP3:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_1]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_1:%.*]] = fmul float [[MUL33]], [[CONV5_1]]
; CHECK-NEXT:    [[CALL14_1:%.*]] = tail call float @cosf(float noundef [[MUL9_1]])
; CHECK-NEXT:    [[TMP4:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_1]], float 0x3FC27631C0000000, float [[TMP3]])
; CHECK-NEXT:    [[MUL124_1:%.*]] = fmul float [[MUL4]], [[CONV5_1]]
; CHECK-NEXT:    [[CALL22_1:%.*]] = tail call float @cosf(float noundef [[MUL124_1]])
; CHECK-NEXT:    [[TMP5:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_1]], float 0xBF89D02040000000, float [[TMP4]])
...
; CHECK-NEXT:    [[TMP6:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_2]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_2:%.*]] = fmul float [[MUL33]], [[CONV5_2]]
; CHECK-NEXT:    [[CALL14_2:%.*]] = tail call float @cosf(float noundef [[MUL9_2]])
; CHECK-NEXT:    [[TMP7:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_2]], float 0x3FC27631C0000000, float [[TMP6]])
; CHECK-NEXT:    [[MUL124_2:%.*]] = fmul float [[MUL4]], [[CONV5_2]]
; CHECK-NEXT:    [[CALL22_2:%.*]] = tail call float @cosf(float noundef [[MUL124_2]])
; CHECK-NEXT:    [[TMP8:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_2]], float 0xBF89D02040000000, float [[TMP7]])
...
; CHECK-NEXT:    [[TMP9:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_3]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_3:%.*]] = fmul float [[MUL33]], [[CONV5_3]]
; CHECK-NEXT:    [[CALL14_3:%.*]] = tail call float @cosf(float noundef [[MUL9_3]])
; CHECK-NEXT:    [[TMP10:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_3]], float 0x3FC27631C0000000, float [[TMP9]])
; CHECK-NEXT:    [[MUL124_3:%.*]] = fmul float [[MUL4]], [[CONV5_3]]
; CHECK-NEXT:    [[CALL22_3:%.*]] = tail call float @cosf(float noundef [[MUL124_3]])
; CHECK-NEXT:    [[TMP11:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_3]], float 0xBF89D02040000000, float [[TMP10]])
...
; CHECK-NEXT:    [[TMP12:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_4]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_4:%.*]] = fmul float [[MUL33]], [[CONV5_4]]
; CHECK-NEXT:    [[CALL14_4:%.*]] = tail call float @cosf(float noundef [[MUL9_4]])
; CHECK-NEXT:    [[TMP13:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_4]], float 0x3FC27631C0000000, float [[TMP12]])
; CHECK-NEXT:    [[MUL124_4:%.*]] = fmul float [[MUL4]], [[CONV5_4]]
; CHECK-NEXT:    [[CALL22_4:%.*]] = tail call float @cosf(float noundef [[MUL124_4]])
; CHECK-NEXT:    [[TMP14:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_4]], float 0xBF89D02040000000, float [[TMP13]])
...
; CHECK-NEXT:    [[TMP15:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_5]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_5:%.*]] = fmul float [[MUL33]], [[CONV5_5]]
; CHECK-NEXT:    [[CALL14_5:%.*]] = tail call float @cosf(float noundef [[MUL9_5]])
; CHECK-NEXT:    [[TMP16:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_5]], float 0x3FC27631C0000000, float [[TMP15]])
; CHECK-NEXT:    [[MUL124_5:%.*]] = fmul float [[MUL4]], [[CONV5_5]]
; CHECK-NEXT:    [[CALL22_5:%.*]] = tail call float @cosf(float noundef [[MUL124_5]])
; CHECK-NEXT:    [[TMP17:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_5]], float 0xBF89D02040000000, float [[TMP16]])
...
; CHECK-NEXT:    [[TMP18:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_6]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_6:%.*]] = fmul float [[MUL33]], [[CONV5_6]]
; CHECK-NEXT:    [[CALL14_6:%.*]] = tail call float @cosf(float noundef [[MUL9_6]])
; CHECK-NEXT:    [[TMP19:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_6]], float 0x3FC27631C0000000, float [[TMP18]])
; CHECK-NEXT:    [[MUL124_6:%.*]] = fmul float [[MUL4]], [[CONV5_6]]
; CHECK-NEXT:    [[CALL22_6:%.*]] = tail call float @cosf(float noundef [[MUL124_6]])
; CHECK-NEXT:    [[TMP20:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_6]], float 0xBF89D02040000000, float [[TMP19]])
...
; CHECK-NEXT:    [[TMP21:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_7]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_7:%.*]] = fmul float [[MUL33]], [[CONV5_7]]
; CHECK-NEXT:    [[CALL14_7:%.*]] = tail call float @cosf(float noundef [[MUL9_7]])
; CHECK-NEXT:    [[TMP22:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_7]], float 0x3FC27631C0000000, float [[TMP21]])
; CHECK-NEXT:    [[MUL124_7:%.*]] = fmul float [[MUL4]], [[CONV5_7]]
; CHECK-NEXT:    [[CALL22_7:%.*]] = tail call float @cosf(float noundef [[MUL124_7]])
; CHECK-NEXT:    [[TMP23:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_7]], float 0xBF89D02040000000, float [[TMP22]])
...
; CHECK-NEXT:    [[TMP24:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL_CLONE]], float 0xBFDF317F00000000, float 0x3FD6C4E720000000)
; CHECK-NEXT:    [[MUL9_CLONE:%.*]] = fmul float [[MUL33]], [[CONV5_CLONE]]
; CHECK-NEXT:    [[CALL14_CLONE:%.*]] = tail call float @cosf(float noundef [[MUL9_CLONE]])
; CHECK-NEXT:    [[TMP25:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL14_CLONE]], float 0x3FC27631C0000000, float [[TMP24]])
...
; CHECK-NEXT:    [[TMP26:%.*]] = tail call float @llvm.fmuladd.f32(float [[CALL22_CLONE]], float 0xBF89D02040000000, float [[TMP25]])
