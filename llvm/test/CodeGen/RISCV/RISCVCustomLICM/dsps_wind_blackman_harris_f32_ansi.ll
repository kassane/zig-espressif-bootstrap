...
define dso_local void @dsps_wind_blackman_harris_f32_arp4(ptr nocapture noundef writeonly %window, i32 noundef %len) local_unnamed_addr {
; CHECK-LABEL: define dso_local void @dsps_wind_blackman_harris_f32_arp4(
