...
define dso_local range(i32 0, 458756) i32 @dspi_dotprod_s16_ansi(ptr nocapture noundef readonly %in_image, ptr nocapture noundef readonly %filter, ptr nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift) local_unnamed_addr {
; CHECK-LABEL: define dso_local range(i32 0, 458756) i32 @dspi_dotprod_s16_ansi(
...
; CHECK-NEXT:    call void @dspi_dotprod_s16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 1, ptr [[I_DATA_078_US]], i32 1, ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
...
; CHECK:       [[CALL_STEP2]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    call void @dspi_dotprod_s16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 2, ptr [[I_DATA_078_US]], i32 2, ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, ptr [[ADD_US_LOC]], align 8
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    br label %[[CALL_MERGE]]
; CHECK:       [[CALL_STEP3]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    call void @dspi_dotprod_s16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 3, ptr [[I_DATA_078_US]], i32 3, ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
; CHECK-NEXT:    [[TMP12:%.*]] = load i64, ptr [[ADD_US_LOC]], align 8
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    br label %[[CALL_MERGE]]
; CHECK:       [[CALL_GENERIC]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    call void @dspi_dotprod_s16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 [[TMP0]], ptr [[I_DATA_078_US]], i32 [[TMP4]], ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
...
codeRepl:                                         ; preds = %for.cond25.preheader.us
  ...
  call void @dspi_dotprod_s16_ansi.for.body28.us(i64 %acc.079.us, i32 %0, ptr %i_data.078.us, i32 %4, ptr %f_data.077.us, i32 %count_x, ptr %add.us.loc)
...
define internal void @dspi_dotprod_s16_ansi.for.body28.us(i64 %acc.079.us, i32 %0, ptr %i_data.078.us, i32 %1, ptr %f_data.077.us, i32 %count_x, ptr %add.us.out) {
; CHECK-LABEL: define internal void @dspi_dotprod_s16_ansi.for.body28.us(
...
; CHECK-NEXT:    [[MUL35_US:%.*]] = mul nsw i32 [[CONV34_US]], [[CONV_US]]
; CHECK-NEXT:    [[CONV36_US:%.*]] = sext i32 [[MUL35_US]] to i64
