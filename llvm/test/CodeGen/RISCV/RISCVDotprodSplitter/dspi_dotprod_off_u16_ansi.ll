...
define dso_local range(i32 0, 458756) i32 @dspi_dotprod_off_u16_ansi(ptr nocapture noundef readonly %in_image, ptr nocapture noundef readonly %filter, ptr nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift, i16 noundef zeroext %offset) local_unnamed_addr {
; CHECK-LABEL: define dso_local range(i32 0, 458756) i32 @dspi_dotprod_off_u16_ansi(
; CHECK-SAME: ptr noundef readonly captures(none) [[IN_IMAGE:%.*]], ptr noundef readonly captures(none) [[FILTER:%.*]], ptr noundef writeonly captures(none) [[OUT_VALUE:%.*]], i32 noundef [[COUNT_X:%.*]], i32 noundef [[COUNT_Y:%.*]], i32 noundef [[SHIFT:%.*]], i16 noundef zeroext [[OFFSET:%.*]]) local_unnamed_addr {
; CHECK-NEXT:  [[ENTRY:.*]]:
...
codeRepl:                                         ; preds = %for.cond25.preheader.us
  ...
  call void @dspi_dotprod_off_u16_ansi.for.body28.us(i64 %acc.081.us, i32 %0, ptr %i_data.080.us, i32 %4, ptr %f_data.079.us, i32 %conv35, i32 %count_x, ptr %add38.us.loc)
...
define internal void @dspi_dotprod_off_u16_ansi.for.body28.us(i64 %acc.081.us, i32 %0, ptr %i_data.080.us, i32 %1, ptr %f_data.079.us, i32 %conv35, i32 %count_x, ptr %add38.us.out) {
; CHECK-LABEL: define internal void @dspi_dotprod_off_u16_ansi.for.body28.us(
...
; CHECK-NEXT:    [[ADD_US:%.*]] = add nuw nsw i32 [[CONV34_US]], [[CONV35]]
; CHECK-NEXT:    [[MUL36_US:%.*]] = mul nuw nsw i32 [[ADD_US]], [[CONV_US]]
; CHECK-NEXT:    [[CONV37_US:%.*]] = zext nneg i32 [[MUL36_US]] to i64
