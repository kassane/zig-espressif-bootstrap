...
define dso_local range(i32 0, 458756) i32 @dspi_dotprod_u16_ansi(ptr noundef readonly captures(none) %in_image, ptr noundef readonly captures(none) %filter, ptr noundef writeonly captures(none) %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift) local_unnamed_addr #0 {
...
for.body28.us:                                    ; preds = %for.cond25.preheader.us, %for.body28.us
  ...
  %11 = load i16, ptr %arrayidx33.us, align 2
  %conv34.us = zext i16 %11 to i32
