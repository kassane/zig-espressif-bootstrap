...
define dso_local range(i32 0, 458756) i32 @dspi_dotprod_u16_ansi(ptr nocapture noundef readonly %in_image, ptr nocapture noundef readonly %filter, ptr nocapture noundef writeonly %out_value, i32 noundef %count_x, i32 noundef %count_y, i32 noundef %shift) local_unnamed_addr {
; CHECK-LABEL: define dso_local range(i32 0, 458756) i32 @dspi_dotprod_u16_ansi(
...
; CHECK-NEXT:  [[ENTRY:.*]]:
; CHECK-NEXT:    [[ADD_US_LOC:%.*]] = alloca i64, align 8
...
; CHECK-NEXT:    [[Y_080_US:%.*]] = phi i32 [ [[INC39_US:%.*]], %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US:.*]] ], [ 0, %[[FOR_COND25_PREHEADER_US_PREHEADER]] ]
; CHECK-NEXT:    [[ACC_079_US:%.*]] = phi i64 [ [[ADD_US_RELOAD:%.*]], %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]] ], [ 0, %[[FOR_COND25_PREHEADER_US_PREHEADER]] ]
...
; CHECK-NEXT:    [[F_DATA_077_US:%.*]] = phi ptr [ [[ADD_PTR37_US:%.*]], %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]] ], [ [[TMP9]], %[[FOR_COND25_PREHEADER_US_PREHEADER]] ]
...
; CHECK-NEXT:    call void @dspi_dotprod_u16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 1, ptr [[I_DATA_078_US]], i32 1, ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
; CHECK-NEXT:    [[TMP10:%.*]] = load i64, ptr [[ADD_US_LOC]], align 8
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    br label %[[CALL_MERGE:.*]]
; CHECK:       [[CALL_STEP2]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    call void @dspi_dotprod_u16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 2, ptr [[I_DATA_078_US]], i32 2, ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
; CHECK-NEXT:    [[TMP11:%.*]] = load i64, ptr [[ADD_US_LOC]], align 8
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    br label %[[CALL_MERGE]]
; CHECK:       [[CALL_STEP3]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    call void @dspi_dotprod_u16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 3, ptr [[I_DATA_078_US]], i32 3, ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
; CHECK-NEXT:    [[TMP12:%.*]] = load i64, ptr [[ADD_US_LOC]], align 8
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    br label %[[CALL_MERGE]]
; CHECK:       [[CALL_GENERIC]]:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    call void @dspi_dotprod_u16_ansi.for.body28.us(i64 [[ACC_079_US]], i32 [[TMP0]], ptr [[I_DATA_078_US]], i32 [[TMP4]], ptr [[F_DATA_077_US]], i32 [[COUNT_X]], ptr [[ADD_US_LOC]])
; CHECK-NEXT:    [[ADD_US_RELOAD_GENERIC:%.*]] = load i64, ptr [[ADD_US_LOC]], align 8
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 -1, ptr [[ADD_US_LOC]])
; CHECK-NEXT:    br label %[[CALL_MERGE]]
; CHECK:       [[CALL_MERGE]]:
; CHECK-NEXT:    [[ADD_US_RELOAD]] = phi i64 [ [[TMP10]], %[[CALL_STEP1]] ], [ [[TMP11]], %[[CALL_STEP2]] ], [ [[TMP12]], %[[CALL_STEP3]] ], [ [[ADD_US_RELOAD_GENERIC]], %[[CALL_GENERIC]] ]
; CHECK-NEXT:    br label %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]]
; CHECK:       [[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]]:
; CHECK-NEXT:    [[ADD_PTR_US]] = getelementptr inbounds i16, ptr [[I_DATA_078_US]], i32 [[MUL20]]
; CHECK-NEXT:    [[ADD_PTR37_US]] = getelementptr inbounds i16, ptr [[F_DATA_077_US]], i32 [[MUL23]]
; CHECK-NEXT:    [[INC39_US]] = add nuw nsw i32 [[Y_080_US]], 1
; CHECK-NEXT:    [[EXITCOND83_NOT:%.*]] = icmp eq i32 [[INC39_US]], [[COUNT_Y]]
; CHECK-NEXT:    br i1 [[EXITCOND83_NOT]], label %[[FOR_COND_CLEANUP]], label %[[FOR_COND25_PREHEADER_US]]
; CHECK:       [[FOR_COND_CLEANUP]]:
; CHECK-NEXT:    [[ACC_0_LCSSA:%.*]] = phi i64 [ 0, %[[IF_END16]] ], [ [[ADD_US_RELOAD]], %[[FOR_COND25_FOR_COND_CLEANUP27_CRIT_EDGE_US]] ]
...
for.cond25.preheader.us:                          ; preds = %for.cond25.for.cond.cleanup27_crit_edge.us, %for.cond25.preheader.us.preheader
  ...
  %acc.079.us = phi i64 [ %add.us.reload, %for.cond25.for.cond.cleanup27_crit_edge.us ], [ 0, %for.cond25.preheader.us.preheader ]
...
codeRepl:                                         ; preds = %for.cond25.preheader.us
  ...
  call void @dspi_dotprod_u16_ansi.for.body28.us(i64 %acc.079.us, i32 %0, ptr %i_data.078.us, i32 %4, ptr %f_data.077.us, i32 %count_x, ptr %add.us.loc)
  %add.us.reload = load i64, ptr %add.us.loc, align 8
...
for.cond.cleanup:                                 ; preds = %for.cond25.for.cond.cleanup27_crit_edge.us, %if.end16
  %acc.0.lcssa = phi i64 [ 0, %if.end16 ], [ %add.us.reload, %for.cond25.for.cond.cleanup27_crit_edge.us ]
...
define internal void @dspi_dotprod_u16_ansi.for.body28.us(i64 %acc.079.us, i32 %0, ptr %i_data.078.us, i32 %1, ptr %f_data.077.us, i32 %count_x, ptr %add.us.out) {
; CHECK-LABEL: define internal void @dspi_dotprod_u16_ansi.for.body28.us(
; CHECK-SAME: i64 [[ACC_079_US:%.*]], i32 [[TMP0:%.*]], ptr [[I_DATA_078_US:%.*]], i32 [[TMP1:%.*]], ptr [[F_DATA_077_US:%.*]], i32 [[COUNT_X:%.*]], ptr [[ADD_US_OUT:%.*]]) {
; CHECK-NEXT:  [[NEWFUNCROOT:.*]]:
; CHECK-NEXT:    br label %[[FOR_BODY28_US:.*]]
; CHECK:       [[FOR_BODY28_US]]:
; CHECK-NEXT:    [[X_075_US:%.*]] = phi i32 [ 0, %[[NEWFUNCROOT]] ], [ [[INC_US:%.*]], %[[FOR_BODY28_US]] ]
; CHECK-NEXT:    [[ACC_174_US:%.*]] = phi i64 [ [[ACC_079_US]], %[[NEWFUNCROOT]] ], [ [[ADD_US:%.*]], %[[FOR_BODY28_US]] ]
; CHECK-NEXT:    [[MUL30_US:%.*]] = mul nsw i32 [[X_075_US]], [[TMP0]]
; CHECK-NEXT:    [[ARRAYIDX_US:%.*]] = getelementptr inbounds i16, ptr [[I_DATA_078_US]], i32 [[MUL30_US]]
; CHECK-NEXT:    [[TMP2:%.*]] = load i16, ptr [[ARRAYIDX_US]], align 2
; CHECK-NEXT:    [[CONV_US:%.*]] = zext i16 [[TMP2]] to i32
; CHECK-NEXT:    [[MUL32_US:%.*]] = mul nsw i32 [[X_075_US]], [[TMP1]]
; CHECK-NEXT:    [[ARRAYIDX33_US:%.*]] = getelementptr inbounds i16, ptr [[F_DATA_077_US]], i32 [[MUL32_US]]
; CHECK-NEXT:    [[TMP3:%.*]] = load i16, ptr [[ARRAYIDX33_US]], align 2
; CHECK-NEXT:    [[CONV34_US:%.*]] = zext i16 [[TMP3]] to i32
; CHECK-NEXT:    [[MUL35_US:%.*]] = mul nuw nsw i32 [[CONV34_US]], [[CONV_US]]
; CHECK-NEXT:    [[CONV36_US:%.*]] = zext nneg i32 [[MUL35_US]] to i64
; CHECK-NEXT:    [[ADD_US]] = add nsw i64 [[ACC_174_US]], [[CONV36_US]]
; CHECK-NEXT:    store i64 [[ADD_US]], ptr [[ADD_US_OUT]], align 8
...
for.body28.us:                                    ; preds = %newFuncRoot, %for.body28.us
  ...
  %acc.174.us = phi i64 [ %acc.079.us, %newFuncRoot ], [ %add.us, %for.body28.us ]
  ...
  %mul32.us = mul nsw i32 %x.075.us, %1
  %arrayidx33.us = getelementptr inbounds i16, ptr %f_data.077.us, i32 %mul32.us
  %3 = load i16, ptr %arrayidx33.us, align 2
  %conv34.us = zext i16 %3 to i32
  %mul35.us = mul nuw nsw i32 %conv34.us, %conv.us
  %conv36.us = zext nneg i32 %mul35.us to i64
  %add.us = add nsw i64 %acc.174.us, %conv36.us
  store i64 %add.us, ptr %add.us.out, align 8
