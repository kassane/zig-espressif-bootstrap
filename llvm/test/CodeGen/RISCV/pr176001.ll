...
define <32 x i64> @main(i1 %tobool93.not, <32 x i64> %0, <32 x i64> %1) #0 {
  ...
  ; CHECK-NEXT:   liveins: $v8m8:0x0000000000000200, $v16m8:0x0000000000000600
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   liveins: $v8m8:0x0000000000000200, $v16m8:0x0000000000000600, $v24m8:0x0000000000000200
  ; CHECK-NEXT: {{  $}}
  ...
  ; CHECK-NEXT:   liveins: $v16m8:0x0000000000000600
  ; CHECK-NEXT: {{  $}}
