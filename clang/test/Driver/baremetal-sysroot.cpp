...
// RUN: rm -rf %t.dir/baremetal_default_sysroot
// RUN: mkdir -p %t.dir/baremetal_default_sysroot/bin
// RUN: mkdir -p %t.dir/baremetal_default_sysroot/lib/clang-runtimes/riscv32-esp-unknown-elf/include/c++/11.2.0
// RUN: mkdir -p %t.dir/baremetal_default_sysroot/lib/clang-runtimes/riscv32-esp-unknown-elf/rv32imac-zicsr-zifencei_ilp32/include/c++/11.2.0
// RUN: echo "MultilibVersion: '1.0'" > %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "Variants:" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "- Dir: riscv32-esp-unknown-elf/rv32imac-zicsr-zifencei_ilp32" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  Flags:" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  - --target=riscv32-esp-unknown-elf" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  - -march=rv32imac_zicsr_zifencei" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  - -mabi=ilp32" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "Mappings:" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "- Match: -march=rv32imac" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  Flags:" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  - -march=rv32imac_zicsr_zifencei" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: ln -s %clang %t.dir/baremetal_default_sysroot/bin/clang

// RUN: %t.dir/baremetal_default_sysroot/bin/clang -no-canonical-prefixes %s -### -o %t.o 2>&1 \
...
// RUN: rm -rf %t.dir/baremetal_default_sysroot
// RUN: mkdir -p %t.dir/baremetal_default_sysroot/bin
// RUN: mkdir -p %t.dir/baremetal_default_sysroot/lib/clang-runtimes/xtensa-esp-unknown-elf/include/c++/11.2.0
// RUN: mkdir -p %t.dir/baremetal_default_sysroot/lib/clang-runtimes/xtensa-esp-unknown-elf/esp32/include/c++/11.2.0
// RUN: echo "MultilibVersion: '1.0'" > %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "Variants:" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "- Dir: xtensa-esp-unknown-elf/esp32" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  Flags:" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  - --target=xtensa-esp-unknown-elf" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: echo "  - -mcpu=esp32" >> %t.dir/baremetal_default_sysroot/lib/clang-runtimes/multilib.yaml
// RUN: ln -s %clang %t.dir/baremetal_default_sysroot/bin/clang
