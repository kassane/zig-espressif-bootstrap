...
// RUN: rm -rf %t.dir
// RUN: mkdir -p %t.dir/basic_riscv32_esp_tree/bin
// RUN: ln -s %clang %t.dir/basic_riscv32_esp_tree/bin/clang
// RUN: ln -s %S/Inputs/basic_riscv32_esp_tree/bin/ld.lld %t.dir/basic_riscv32_esp_tree/bin/ld.lld
// RUN: ln -s %S/Inputs/basic_riscv32_esp_tree/bin/riscv32-esp-elf-clang-as %t.dir/basic_riscv32_esp_tree/bin/riscv32-esp-elf-clang-as
// RUN: ln -s %S/Inputs/basic_riscv32_esp_tree/bin/riscv32-esp-elf-clang-ld %t.dir/basic_riscv32_esp_tree/bin/riscv32-esp-elf-clang-ld
// RUN: ln -s %S/Inputs/basic_riscv32_esp_tree/lib %t.dir/basic_riscv32_esp_tree/lib
...
// RUN: %t.dir/basic_riscv32_esp_tree/bin/clang %s -### 2>&1 --target=riscv32-esp-elf -fno-integrated-as \
// RUN:     -L some/directory/user/asked/for \
// RUN:     --sysroot=%t.dir/basic_riscv32_esp_tree/lib/clang-runtimes \
...
// RUN: %t.dir/basic_riscv32_esp_tree/bin/clang %s -### 2>&1 --target=riscv32-esp-elf --ld-path=riscv32-esp-elf-clang-ld \
// RUN:     -L some/directory/user/asked/for \
// RUN:     --sysroot=%t.dir/basic_riscv32_esp_tree/lib/clang-runtimes \
// RUN:     -ccc-install-dir %t.dir/basic_riscv32_esp_tree/bin \
...
// RUN: %t.dir/basic_riscv32_esp_tree/bin/clang %s -### 2>&1 --target=riscv32-esp-elf -march=rv32imafdc -mabi=ilp32f \
// RUN:     --sysroot=%t.dir/basic_riscv32_esp_tree/lib/clang-runtimes \
// RUN:   | FileCheck --check-prefix=CHECK-ESP-RV32IMAFC %s
...
// RUN: %t.dir/basic_riscv32_esp_tree/bin/clang %s -### 2>&1 \
...
// RUN: touch %t.dir/baremetal_clang_rt_arch/lib/libclang_rt.builtins-riscv32.a
// RUN: %t.dir/basic_riscv32_esp_tree/bin/clang %s -### 2>&1 \
// RUN:     --target=riscv32-esp-elf \
...
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/bin/xtensa-esp32-elf-clang-as %t.dir/basic_xtensa_esp_tree/bin/xtensa-esp32-elf-clang-as
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/bin/xtensa-esp32-elf-clang-ld %t.dir/basic_xtensa_esp_tree/bin/xtensa-esp32-elf-clang-ld
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/bin/xtensa-esp32s2-elf-clang-as %t.dir/basic_xtensa_esp_tree/bin/xtensa-esp32s2-elf-clang-as
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/bin/xtensa-esp32s2-elf-clang-ld %t.dir/basic_xtensa_esp_tree/bin/xtensa-esp32s2-elf-clang-ld
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/bin/xtensa-esp32s3-elf-clang-as %t.dir/basic_xtensa_esp_tree/bin/xtensa-esp32s3-elf-clang-as
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/bin/xtensa-esp32s3-elf-clang-ld %t.dir/basic_xtensa_esp_tree/bin/xtensa-esp32s3-elf-clang-ld
// RUN: ln -s %S/Inputs/basic_xtensa_esp_tree/lib %t.dir/basic_xtensa_esp_tree/lib

// ESP32 is default

// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 --target=xtensa-esp-elf \
// RUN:     -L some/directory/user/asked/for \
// RUN:     --sysroot=%t.dir/basic_xtensa_esp_tree/lib/clang-runtimes \
// RUN:   | FileCheck --check-prefix=CHECK-ESP-ESP32 %s
// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 --target=xtensa-esp-elf -mcpu=esp32 \
// RUN:     -L some/directory/user/asked/for \
// RUN:     --sysroot=%t.dir/basic_xtensa_esp_tree/lib/clang-runtimes \
// RUN:   | FileCheck --check-prefix=CHECK-ESP-ESP32 %s
// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 --target=xtensa-esp-elf \
...
// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 --target=xtensa-esp-elf -fno-integrated-as \
// RUN:     -L some/directory/user/asked/for \
// RUN:     --sysroot=%t.dir/basic_xtensa_esp_tree/lib/clang-runtimes \
...
// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 --target=xtensa-esp-elf --ld-path=xtensa-esp32-elf-clang-ld    \
// RUN:     -L some/directory/user/asked/for \
// RUN:     --sysroot=%t.dir/basic_xtensa_esp_tree/lib/clang-runtimes \
// RUN:     -ccc-install-dir %t.dir/basic_xtensa_esp_tree/bin \
...
// RUN: mkdir -p %t.dir/baremetal_clang_rt_noarch/lib
// RUN: touch %t.dir/baremetal_clang_rt_noarch/lib/libclang_rt.builtins.a
// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 \
...
// RUN: rm -rf %t.dir/baremetal_clang_rt_arch
// RUN: mkdir -p %t.dir/baremetal_clang_rt_arch/lib
// RUN: touch %t.dir/baremetal_clang_rt_arch/lib/libclang_rt.builtins-xtensa.a
// RUN: %t.dir/basic_xtensa_esp_tree/bin/clang %s -### 2>&1 \
// RUN:     --target=xtensa-esp-elf \
// RUN:     --sysroot=%t.dir/baremetal_clang_rt_arch \
